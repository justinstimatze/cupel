...
medium: novel
backing: slot-proven
source: Project Gutenberg #135 (Isabel F. Hapgood translation, 1887; line numbers refer to pg135.txt)
engines: [redemption]
layer: content
verified: true
status: slot-proven; the canonical Western-literature redemption-engine specimen
related_works:
  - "a-christmas-carol :: the self-reformation sub-register"
  - "the-chronicles-of-narnia :: the substitutionary-atonement sub-register"
  - "dianetics :: the cluster-counterfeit register where redemption is asserted but not paid"
related_theory:
...
**The bundle.** Single-engine specimen at 1,500+ pages — redemption's full operation, the slot-2 cost made the substantive content of the novel. Anchors one of three redemption sub-registers with [A Christmas Carol](/cupel/works/a-christmas-carol/) (self-reformation register) and [The Chronicles of Narnia](/cupel/works/the-chronicles-of-narnia/) (substitutionary-atonement register).
...
1. **Received-grace + lifetime-of-care register** — *Les Misérables*. Slot-2 given before the bearer chooses, ratified by sustained care.
2. **Self-reformation register** — *A Christmas Carol* ([A Christmas Carol](/cupel/works/a-christmas-carol/), Dickens 1843). Slot-2 is the bearer's own reckoning + reformed conduct.
3. **Substitutionary-atonement register** — *The Chronicles of Narnia* ([The Chronicles of Narnia](/cupel/works/the-chronicles-of-narnia/), Lewis 1950). Slot-2 paid by another (Aslan at the Stone Table) on behalf of the bearer (Edmund).

All three preserve the substantive-cost guard at different positions: cost paid by the bearer's lifetime (Hugo), by reformed conduct (Dickens), or by the substitute (Lewis). What none does is deliver grace *without* the cost being paid by someone — that's redemption's counterfeit-pole, *cheap grace*, which appears in the cult cluster ([Dianetics: The Modern Science of Mental Health](/cupel/works/dianetics/)) where the cluster's slot-2 is asserted but not paid.