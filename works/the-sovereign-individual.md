---
work: The Sovereign Individual — Mastering the Transition to the Information Age
author: James Dale Davidson and William Rees-Mogg
year: 1997
medium: nonfiction
backing: slot-proven
source: Touchstone 1997 ed
engines: [apotheosis, liberation/autonomy, impunity, abundance, mastery, belonging, the double life, order/legibility]
layer: content
verified: true
related_works:
...
- **belonging** · content · also-runs · ✓ — the cognitive elite as transnational tribe, with the Knights Templar / Hanseatic League as template. Tribal membership without tribal obligation.
- **the double life** · content · also-runs · ✓ — citizenship arbitrage, alternate residency, encrypted communications: the multi-jurisdictional partial-citizen as operationalized double-life. Secondary register.
- **order/legibility** · content · also-runs · ✓ — the totalizing 1997-prediction-of-21st-century structure as the cluster's gravitational-frame leg. Secondary; primary load lives at the cluster-frame scale.

**The bundle.** The Sov-constellation's foundational specimen: 8 engines at pure-counterfeit pole, the catalog's broadest-spectrum offering per page. Engine-breadth tracks operational-extension-scope — Sov is a vision for jurisdiction-free total-life-takeover, paralleling Jonestown ([Raven: The Untold Story of the Rev. Jim Jones and His People](/cupel/works/raven/), 7 engines). Pre-cyber-template ancestors at [Atlas Shrugged](/cupel/works/atlas-shrugged/) and [The Fountainhead](/cupel/works/the-fountainhead/) (Rand's moral-philosophical strike → Davidson + Rees-Mogg's information-age-technological strike); compound-cluster bridge to startup-canon at [Zero to One: Notes on Startups, or How to Build the Future](/cupel/works/zero-to-one/).
...
- **caretaking/being-needed** — actively inverted. The welfare-state's care-from-above is reframed as parasitism: "Roman town was a parasitic community, not a center of production: 'In the Roman period, the dominant function of a city was of a political order. It lived primarily from the revenues draining into it from its surroundings by the agency of the land tax.'" (l. 1019)
- **redemption** — no register of past wrongs forgiven. The cage is reframed as never-having-been-deserved.
- **virtue of defeat** — anti. The non-escapees are the cows who deserve milking; defeat = failure to read the transition.
- **homecoming/reunion** — anti. The future is the elsewhere; no return to a prior wholeness.
