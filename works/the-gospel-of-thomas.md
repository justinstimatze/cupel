...
author: anonymous (composite Jesus-sayings tradition)
year: "c. 50-150 CE"
medium: scripture
backing: slot-proven
source: Lambdin tr. 1977 (standard scholarly English; in-copyright — cited bibliographically by saying-number)
engines: [apotheosis, mastery, order/legibility, legacy/transcendence, liberation/autonomy]
layer: content
verified: true
queued_engines: [belonging, homecoming/reunion, virtue-of-defeat]
related_works:
...
**Engines**
- **apotheosis** · content · spine · ✓ — the dominant engine, running across 15-20 sayings. Saying 108: "He who will drink from my mouth will become like me. I myself shall become he, and the things that are hidden will be revealed to him." Saying 3: "the kingdom is inside of you, and it is outside of you. When you come to know yourselves, then you will become known, and you will realize that it is you who are the sons of the living father." Slot-3 ascended state is *becoming like Jesus* — drinking from his mouth, ruling-over-the-All, finding the kingdom-within.
...
- **Redemption** — no cross, no atonement, no substitutionary sacrifice. Thomas's soteriology is gnostic-self-recognition, not redemptive-act-of-Christ. The central engine of canonical Christianity is *missing* from Thomas.
- **Caretaking** — no Good Samaritan, no widow's mite, no Ruth, no "visit the fatherless and widows." The whole caretaking register is structurally absent.
- **Security/safety** — no God-as-fortress, no Psalter-equivalent refuge frame. The seeker is alone with the hidden meaning, not under divine protection.
- **Abundance** — anti-material throughout (saying 56 register; saying 64 banquet-rejection).
- **Impunity** — no "all things are lawful" register, no chosen-people exemption.
- **Being-desired** — no bhakti, no bridegroom-bride. Thomas is austere; the seeker pursues, doesn't get pursued.
- **Unleashing** — no Pentecost, no Spirit-rushing-on register.
- **The-double-life** — no Joseph/Esther/Moses narratives; Thomas is sayings only.
- **Repricing** — the kingdom-within frame inverts (interiorizes) rather than reprices (revalues).
- **Purity/contamination** — actively *inverted*: saying 89 dismisses the wash the outside of the cup register; Mosaic purity dismissed, not transmuted.

### Anti-prediction strongly confirmed

The Bible-vs-Gita-vs-Thomas comparison:

| Engine | Bible (canon-winner, multi-genre) | Gita (canon-winner, single-genre) | Thomas (canon-loser, single-genre) |
|---|---|---|---|
...
| liberation/autonomy | ✓ | ✓ | ✓ |
| impunity | ✓ | ✓ | absent |
| security/safety | ✓ | ✓ | absent |
| virtue-of-defeat | ✓ | ✓ | partial (beatitude-fragments) |
| homecoming/reunion | ✓ | ✓ | partial |
| being-desired | queued | ✓ | absent |
| belonging | ✓ | queued | partial (narrow-gnostic-elect) |
| redemption | ✓ | queued | absent |
| caretaking | ✓ | absent | absent |
| purity/contamination | ✓ | queued | actively-inverted |
| unleashing | ✓ | queued | absent |
| repricing | ✓ | absent | absent |
| abundance | ✓ | inverted | inverted |
| the-double-life | queued | absent | absent |
| **Confirmed** | **16** | **10** | **5** |
| **Queued/partial** | **2** | **5** | **3** |
| **Absent** | **0** | **3** | **10** |

The pattern is structurally clean:
- **Canon-winners** (Bible, Gita) run 10-16 engines load-bearingly
- **Canon-loser** (Thomas) runs 5 engines load-bearingly with 10 explicitly-absent engines
- The gap is *not just count* — the *kinds of engines* matter. Thomas concentrates in apotheosis + mastery + order/legibility + legacy/transcendence + liberation (the gnostic-specialist cluster); it lacks the engines that drive mass-recruitment (caretaking, security, redemption, being-desired, belonging-as-people-of-God).
...
- The mourner who needs a comforter (no virtue of defeat as blessed mourning)
- The afflicted who needs a healer (no caretaking, no Good Samaritan)
- The threatened who needs a fortress (no security/safety register)
- The desiring-to-be-loved who needs bhakti (no being-desired)
- The ethnic-tribal-bond-seeking who needs chosen-people (no belonging-as-Israel)
- The wage-laborer who needs prosperity-promise (no abundance)
...
- **Anti-prediction strongly confirmed**: failed-canon Thomas runs 5 engines vs canon-winner Bible's 16
- **Engine-breadth refinement to memetic-selection**: canon-formation selects for breadth of wish-recruitment, not just total engine-count; mass-recruitment engines (caretaking + security + redemption + virtue-of-defeat-as-comfort + being-desired + abundance) are the ones canon-losers tend to lack
- **Gnostic-specialist cluster**: Thomas's engines (apotheosis + mastery + order/legibility + legacy + liberation) form a *specialist-intellectual-elite* recruitment-profile distinct from mass-religious recruitment. Other gnostic texts (Gospel of Mary, Gospel of Philip, Apocryphon of John) predicted to run similar narrow-specialist profiles
- **Liberation/autonomy backing-update**: gnostic-kingdom-within freedom-from-external-religious-authority is a new backing-register alongside moksha-via-yogic-discipline (Gita) and the existing 11 backings

### What this dossier does NOT confirm

- That Thomas's failure was *only* due to engine-narrowness; political + ecclesiastical + textual-tradition factors also drove canon-exclusion
- That all gnostic texts would slot-test at similar engine-counts (Gospel of Mary likely runs caretaking via Mary-as-comforter; the broader Nag Hammadi corpus has more variety)
