...
author: Vyasa (trad.); trans. Sir Edwin Arnold (The Song Celestial)
year: c. 100 BCE; trans. 1885
medium: scripture (epic poem)
backing: reviewed
source: Edwin Arnold, *The Song Celestial; Or, Bhagavad-Gîtâ (from the Mahâbhârata)*, 1885 (Project Gutenberg #2388 — PD)
engines: [apotheosis, mastery, order/legibility, legacy/transcendence, liberation/autonomy, impunity, security/safety, being-desired, homecoming/reunion, virtue-of-defeat]
layer: content
verified: true
queued_engines: [belonging, redemption, caretaking, purity/contamination, unleashing]
related_works:
...
Non-Abrahamic counterpart slot-test to [The Holy Bible (KJV 1611)](/cupel/works/the-bible/). The Gita is the most-cited and most-read section of the Mahabharata (Bhishma Parva, Book 6, chapters 23-40), functioning as a standalone religious text in Hindu tradition since at least the 3rd century CE. Translates Krishna's pre-battle teaching to Arjuna across 18 chapters / ~700 verses.
...
1. **Full Mahabharata slot-test** — predicted 14-17 engines (Gita's 10 + epic-additions)
2. **Tao Te Ching slot-test** — another single-genre canonical text; tests the genre-breadth refinement (Tao Te Ching predicted at 6-8 engines)
3. **Upanishads slot-test** — Hume 1921 PD edition; tests another Hindu canonical text at different genre (mystical-philosophical aphorism)
4. **Gospel of Thomas slot-test** — failed-canon anti-prediction test; predicted at 4-6 engines (lost competitive-canonization, no genre-expansion)
5. **Quran + Hadith slot-test** — different mono-theistic high-density predicted; tests whether absolute tawhid precludes any engines
6. **Liberation/autonomy backing-update** — [backings](/cupel/theory/backings/) should add *moksha-via-yogic-discipline* as a new backing-register alongside the existing 11 backings
7. **Bible being-desired engine re-evaluation** — the Gita's bhakti clarifies that being-desired CAN fire cleanly at religious-canonical scale; the Bible queue should be re-tested with this calibration